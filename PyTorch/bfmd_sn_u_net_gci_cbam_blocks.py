...
class Down(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,SN,Distortion,distortion_probabilty=0,feature_num=0):
        ...
        self.maxpool_conv = nn.Sequential(
            nn.MaxPool2d(2),
            DoubleConv_BFMD_SN_Unet_GCI_CBAM(in_channels, out_channels,distortion_probabilty,feature_num,SN=SN,Distortion=Distortion)
        )
...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,SN,Distortion,distortion_probabilty=0,feature_num=0):
        ...
        self.conv = DoubleConv_BFMD_SN_Unet_GCI_CBAM(int(in_channels*2.5), out_channels,distortion_probabilty,feature_num,SN=SN,Distortion=Distortion)
