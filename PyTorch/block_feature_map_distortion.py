        ...
        if not self.training: 
            ...
            if x.dim()==4:           
                ...
                if self.block_size == width and self.block_size == height:            
                    ...
                    block_pattern = -torch.nn.functional.max_pool2d(input=-block_pattern, kernel_size=(self.block_size, self.block_size), stride=(1, 1), padding=self.block_size // 2)
